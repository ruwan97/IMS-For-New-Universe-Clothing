...
<?php include 'Partials/left_panel.php' ?>
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                            ...
                            <a class="nav-link" href="<?php echo base_url('index.php/Welcome/page_login'); ?>"><i class="fa fa-power-off"></i> Logout</a>
                        </div>
                    </div>
    ...
    <script src="<?php echo base_url('vendors/jqvmap/dist/maps/jquery.vmap.world.jsff'); ?>"></script>
    <script>
        (function($) {
            "use strict";
