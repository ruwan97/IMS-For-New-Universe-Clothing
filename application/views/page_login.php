            ...
            <div class="login-content">
                ...
                <div class="login-form rounded">
					...
					<?php	echo form_open('form_controller/Logging_user');	?>
                        ...
                        <button href="<?php //echo base_url('index.php/Welcome/dashboard'); ?>" type="submit" class=" btn btn-dark btn-flat m-b-30 m-t-30 rounded" name ="signin">Sign in</button>

                        <div class="register-link m-t-15 text-center">
                            <p>Don't have account ? <a href="<?php echo base_url('index.php/Welcome/User_Request'); ?>"> Request Admin</a></p>
                        </div>
                    <?php echo form_close(); ?>
                </div>
            </div>
